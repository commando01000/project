...
<head>
  ...
  <li><a href="index">Home</a></li>
        ...
        <form method="post" action="VisaController.php">
            <div class="container">
            <h1>VISA</h1>
            <p>Please fill in this form to pay by VISA.</p>
            <hr>
            Enter Name On Card: <input type="text" name="name" placeholder="Enter Name On Card"required>
            <br><br>
